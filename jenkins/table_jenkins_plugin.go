...
func tableJenkinsPlugin() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "has_update", Type: proto.ColumnType_BOOL, Transform: transform.FromField("HasUpdate"), Description: ""},
			{Name: "id", Type: proto.ColumnType_STRING, Transform: transform.FromField("ShortName"), Description: ""},
			{Name: "long_name", Type: proto.ColumnType_STRING, Transform: transform.FromField("LongName"), Description: ""},
			{Name: "pinned", Type: proto.ColumnType_BOOL, Transform: transform.FromField("Pinned"), Description: ""},
			{Name: "short_name", Type: proto.ColumnType_STRING, Transform: transform.FromField("ShortName"), Description: ""},
			{Name: "supports_dynamic_load", Type: proto.ColumnType_STRING, Transform: transform.FromField("SupportsDynamicLoad"), Description: ""},
			...
			{Name: "backup_version", Type: proto.ColumnType_JSON, Transform: transform.FromField("BackupVersion"), Description: ""},
